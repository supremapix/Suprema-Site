  ...
  return (
    <footer id="contato" className="bg-slate-900 text-white pt-12 md:pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col items-center justify-center gap-2 text-center text-gray-500 text-sm">
          <p className="flex items-center gap-1">
            Desenvolvido <Heart className="w-4 h-4 text-red-500 fill-current animate-pulse" /> por <strong className="text-white">Suprema Sites Express</strong>
          </p>
          <p className="opacity-70">&copy; {new Date().getFullYear()} Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
